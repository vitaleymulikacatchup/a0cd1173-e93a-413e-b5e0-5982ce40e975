...
export const metadata: Metadata = {
  title: "Ai-SDK - Build Intelligent Chatbots with Advanced AI",
  description: "The most comprehensive SDK for integrating AI chatbot capabilities. Multi-provider support, real-time analytics, and enterprise-ready features. Start free today.",
  keywords: "AI SDK, chatbot API, artificial intelligence, conversational AI, OpenAI, Claude, Gemini, chatbot development",
  openGraph: {
    title: "Ai-SDK - Build Intelligent Chatbots with Advanced AI",
    description: "The most comprehensive SDK for integrating AI chatbot capabilities. Multi-provider support, real-time analytics, and enterprise-ready features.",
    siteName: "Ai-SDK",
    type: "website",
    images: [
      {
        url: "https://images.pexels.com/photos/16629368/pexels-photo-16629368.jpeg?auto=compress&cs=tinysrgb&h=650&w=940",
        alt: "AI chatbot demonstration"
      }
    ]
  },
  twitter: {
    ...
    title: "Ai-SDK - Build Intelligent Chatbots with Advanced AI",
    description: "The most comprehensive SDK for integrating AI chatbot capabilities. Start building smarter conversations today.",
    images: ["https://images.pexels.com/photos/16629368/pexels-photo-16629368.jpeg?auto=compress&cs=tinysrgb&h=650&w=940"]
  },
  robots: {
    index: true,
    follow: true
